...
export class DummyConstants {
    ...
    static readonly DUMMY_MEMES: Meme[] = [
        ...
        { id: 8, name: 'doge', born: '2014-12-01', died: '2014-12-01', description: 'such description', tags: [AppConstants.TAGS.ANIMALS], image: 'https://i.imgur.com/zl6yZqH.jpg', creator: DummyConstants.DUMMY_USERACCOUNTS[1] , date_created: '2019-04-20', hub: DummyConstants.DUMMY_HUBS[0]},
