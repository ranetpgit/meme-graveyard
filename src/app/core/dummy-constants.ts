...
export class DummyConstants {
    ...
    static readonly DUMMY_MEMES: Meme[] = [
        { id: 1, name: 'John Cena', born: '2014-12-01', died: '2015-12-01', description: 'And his name is John Cena', tags: [DummyConstants.DUMMY_TAGS[3], DummyConstants.DUMMY_TAGS[15]], image: 'https://i.imgur.com/Du7RtnV.jpg', creator: DummyConstants.DUMMY_USERACCOUNTS[1], date_created: '2018-03-18', hub: DummyConstants.DUMMY_HUBS[0], upvotes: 1000, downvotes: 100 },
        { id: 2, name: 'MLG', born: '2013-12-01', died: '2015-12-01', description: 'Montage Parodies', tags: [DummyConstants.DUMMY_TAGS[4]], image: 'https://i.imgur.com/6x3xozV.jpg', creator: DummyConstants.DUMMY_USERACCOUNTS[2] , date_created: '2018-03-20', hub: DummyConstants.DUMMY_HUBS[0], upvotes: 200, downvotes: 10 },
        { id: 3, name: 'Rage faces', born: '2011-12-01', died: '2013-05-01', description: 'le rage comics', tags: [DummyConstants.DUMMY_TAGS[0], DummyConstants.DUMMY_TAGS[9]], image: 'https://i.imgur.com/mjlommB.png', creator: DummyConstants.DUMMY_USERACCOUNTS[1] , date_created: '2018-05-22', hub: DummyConstants.DUMMY_HUBS[0], upvotes: 33, downvotes: 2 },
        { id: 4, name: 'My Name is Jeff', born: '2014-06-04', died: '2017-05-01', description: 'My namma Jeff :)', tags: [DummyConstants.DUMMY_TAGS[1]], image: 'https://i.imgur.com/06rFkO0.jpg', creator: DummyConstants.DUMMY_USERACCOUNTS[2] , date_created: '2018-06-08', hub: DummyConstants.DUMMY_HUBS[0], upvotes: 2134, downvotes: 243 },
        ...
        { id: 7, name: 'Loss', born: '2018-01-01', died: '2018-05-01', description: '[i] i-i ii i_', tags: [DummyConstants.DUMMY_TAGS[9]], image: 'https://i.imgur.com/SqiQB7v.jpg', creator: DummyConstants.DUMMY_USERACCOUNTS[2] , date_created: '2019-01-16', hub: DummyConstants.DUMMY_HUBS[0], upvotes: 3435, downvotes: 43 },
        { id: 8, name: 'doge', born: '2014-12-01', died: '2014-12-01', description: 'such description', tags: [DummyConstants.DUMMY_TAGS[18], DummyConstants.DUMMY_TAGS[10]], image: 'https://i.imgur.com/zl6yZqH.jpg', creator: DummyConstants.DUMMY_USERACCOUNTS[1] , date_created: '2019-04-20', hub: DummyConstants.DUMMY_HUBS[1], upvotes: 643, downvotes: 45 },
        { id: 9, name: 'Change My Mind', born: '2018-02-16', died: '2018-06-01', description: 'x is y, change my mind', tags: [DummyConstants.DUMMY_TAGS[12]], image: 'https://i.imgur.com/71dGzOh.jpg', creator: DummyConstants.DUMMY_USERACCOUNTS[2] , date_created: '2019-05-21', hub: DummyConstants.DUMMY_HUBS[0], upvotes: 734, downvotes: 45 },
        { id: 10, name: 'Despacito 2', born: '2018-05-01', died: '', description: 'Despacito 2 confirmed', tags: [DummyConstants.DUMMY_TAGS[14], DummyConstants.DUMMY_TAGS[13]], image: 'https://i.imgur.com/JaiDr5g.jpg', creator: DummyConstants.DUMMY_USERACCOUNTS[0] , date_created: '2019-02-05', hub: DummyConstants.DUMMY_HUBS[0], upvotes: 234, downvotes: 32 },
    ];
